...
_lr_action_items = {'CODE':([0,10,],[4,4,]),'TITLE':([0,10,],[5,5,]),'$end':([1,2,3,10,11,12,],[0,-1,-2,-3,-5,-4,]),'LBRACKETS':([4,5,],[6,7,]),'STRING':([6,7,],[8,9,]),'RBRACKETS':([8,9,],[10,11,]),}
...
_lr_goto_items = {'block':([0,10,],[1,12,]),'block_code':([0,10,],[2,2,]),'block_title':([0,10,],[3,3,]),}
